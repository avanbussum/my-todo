...
const Modal = () => {
  ...
  return (
    <>
      <button
        className="rounded-[10px] w-full p-[10px] border-none outline-none bg-[#031956] bg-blue-200 text-white hover:bg-blue-500 shadow hover:shadow-lg focus:outline-none mb-3"
        type="button"
