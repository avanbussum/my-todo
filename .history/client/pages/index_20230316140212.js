  ...
  return (
    <div className='bg-[#97b5fe] h-screen w-screen flex justify-center py-6'>
      {!isUserLoggedIn ? <ConnectWalletButton connectWallet={connectWallet}/> :
        'is this the correct network?' ? <TodoList patients={patients} firstName={firstName} setInput1={setInput1} lastName={lastName} setInput2={setInput2} addPatient={addPatient} deletePatient={deletePatient}/> : 
      <WrongNetworkMessage />}
    </div>
  )
}
